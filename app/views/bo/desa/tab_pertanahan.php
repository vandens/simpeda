		...
		<div class="widget-box transparent">
			<div class="widget-body">
				<div class="widget-main">	
					...
					<?php 
					$mix 	= array('green'=>'status','blue'=>'peruntukkan','purple'=>'penggunaan');
					foreach ($mix as $m => $x) {
					?>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="form-field-1"> <?php echo ucwords(str_replace('_',' ',substr($keys,bcadd(strlen($x),1)))); ?></label>
							<div class="col-sm-6">						
