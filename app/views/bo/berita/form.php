						...
						<div class="widget-main">						
							<div class='row'>
								<div class='col-xs-12 col-sm-10'>	
										...
										<div class="form-group">
											...
											<div class="col-xs-6  col-sm-10">						
												<select name='category'>
													<?php 
													foreach($dlist['CAT'] as $val){														
														$sel 	= (ucwords($category)	 == $val->set_value) ? 'selected="selected"' : '';
														echo '<option value="'.$val->set_id.'" '.$sel.'>'.ucwords(strtolower($val->set_value)).'</option>';
													}
													?>
												</select>
											</div>
									...
									<div class='col-xs-6 col-sm-4' style='margin-left:-50px'>
										<div class="form-group">								
												<label class=" col-xs-5 col-sm-5 control-label" for="form-field-1"> Bts Tampil</label>
												<div class="col-xs-6  col-sm-7">						
