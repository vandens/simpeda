								...
								<div class="form-group">
									...
									<div class="col-sm-9">	
										...
										<div class='col-sm-5 col-xs-6'>	
											<input type='text' class='col-xs-12 col-sm-12' <?php echo $$disabled; ?>  name='resident_card_no' value='<?php echo $resident_card_no; ?>' placeholder='No Kartu Keluarga'  required onkeypress='return AlfaNum(event);'>
										
										<label>
											<input class="ace" <?php echo $disabled; ?> type="checkbox" <?php echo $disabled; ?> name="is_card_no">
							...
							<div class="widget-main">	
								...
								<div class="form-group">
									...
									<div class="col-sm-5">	
										...
										<label>
											<input class="ace" <?php echo $disabled; ?> type="checkbox" name="is_resident_no">
