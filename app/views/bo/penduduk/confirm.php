			...
			<div class='alert alert-danger' style='display:none'><?php echo validation_errors(); ?></div>
				<div class="widget-box transparent">
					...
					<div class='pull-right'>	
						...
						<?php echo ($this->_priv->PENC || $this->_priv->PENU) ? "<button data-rel='tooltip' type='submit' name='submit' value='".$val."'  class='btn btn-primary btn-white btn-round btn-sm fa ace-icon fa fa-save'  title='simpan' data-placement='bottom'></button>" : ''; ?>
					</div>
					</div>
							...
							<div class="profile-user-info profile-user-info-striped">
									...
									<div class="profile-info-row">
										<div class="profile-info-name" style='width:175px'> Desa</div>
											<div class="profile-info-value ">
												<span class="editable"><?php echo ucwords($village_name);?></span>
											</div>				
